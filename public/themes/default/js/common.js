...
;(function( $, window, document )
{
	...
	$(document).ready(function()
	{
		...
		if (typeof $.fn.dataTable != 'undefined') {
			$.fn.dataTable.ext.classes.sWrapper = 'no-margin last-child';
			$.fn.dataTable.ext.classes.sInfo = 'message no-margin';
			$.fn.dataTable.ext.classes.sLength = 'float-left';
			$.fn.dataTable.ext.classes.sFilter = 'float-right';
			$.fn.dataTable.ext.classes.sPaging = 'sub-hover paging_';
			$.fn.dataTable.ext.classes.sPagePrevEnabled = 'control-prev';
			$.fn.dataTable.ext.classes.sPagePrevDisabled = 'control-prev disabled';
			$.fn.dataTable.ext.classes.sPageNextEnabled = 'control-next';
			$.fn.dataTable.ext.classes.sPageNextDisabled = 'control-next disabled';
			$.fn.dataTable.ext.classes.sPageFirst = 'control-first';
			$.fn.dataTable.ext.classes.sPagePrevious = 'control-prev';
			$.fn.dataTable.ext.classes.sPageNext = 'control-next';
			$.fn.dataTable.ext.classes.sPageLast = 'control-last';
		}
	...
	$.fn.loadWithEffect = function()
	{
		...
		args[index] = function(responseText, textStatus, XMLHttpRequest)
		{
			...
			let refElement = getNodeRefElement(this);
			let layer = $(refElement).next('.loading-mask');
			let span = layer.children('span');
