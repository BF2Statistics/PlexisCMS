...
<head>
    ...
    <script type="text/javascript" src="{{ app.theme_url }}/js/lists.js"></script>
    <script type="text/javascript" src="{{ app.theme_url }}/js/modules/Error/error.js"></script>

    <!-- Required Stylesheets -->
    <link rel="stylesheet" type="text/css" href="{{ app.theme_url }}/css/reset.css" media="screen">
    <link rel="stylesheet" type="text/css" href="{{ app.theme_url }}/css/common.css" media="screen">
    <link rel="stylesheet" type="text/css" href="{{ app.theme_url }}/css/form.css" media="screen">
    <link rel="stylesheet" type="text/css" href="{{ app.theme_url }}/css/standard.css" media="screen">
    <link rel="stylesheet" type="text/css" href="{{ app.theme_url }}/css/special-pages.css" media="screen">
    <link rel="stylesheet" type="text/css" href="{{ app.theme_url }}/css/simple-lists.css" media="screen">
</head>
