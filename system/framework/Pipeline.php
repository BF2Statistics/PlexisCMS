 ...
 * Class Pipeline
 *
 * A pipeline facilitates the sequential processing of an object through a defined series of pipes.
 * Each pipe alters or acts upon the object before passing it to the next pipe in the sequence.
 *
